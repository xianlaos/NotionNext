...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '数字跳动博客', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '社区信息播报', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://4569999.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字跳动博客, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个交易员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
